...
router.post('/', isAuthenticated, categoryValidation, validate, categoryController.createCategory);

//delete Route for categories collection
router.delete("/:id", categoryController.deleteCategory);

//Put Route for categories collection
router.put('/:id', isAuthenticated, categoryValidation, validate, categoryController.updateCategory);
